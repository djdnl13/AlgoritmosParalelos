...
exactly the same as send-standard, but the communication is synchronous.

The sender process sends a message to the receiver. This receives
the message and sends it back. Both processes use synchronous send
operations (MPI_Ssend)
